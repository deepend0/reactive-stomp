...
public class Utils {
    ...
    public Utils(MutinyEmitter<ExternalMessage> serverInboundEmitter, Deque<ExternalMessage> serverOutboundList, Deque<ExternalMessage> serverOutboundHeartbeats) {
    ...
    public long connectClient(String sessionId) {
        ...
        Awaitility.await().atMost(AWAIT_AT_MOST).pollInterval(Duration.ofMillis(300)).until(() -> serverOutboundHeartbeats.size() > 2);
        return timerId;
    }
